    ...
    if (testBegin("storageNew()"))
    {
        ...
        hrnLibSsh2ScriptSet((HrnLibSsh2 [])
        {
            ...
            {.function = HRNLIBSSH2_KNOWNHOST_ADDC,
             .param = "[\"localhost\",null,\"12345678901234567890\",20,\"Generated from pgBunker\",23,589825]"},
        ...
        hrnLibSsh2ScriptSet((HrnLibSsh2 [])
        {
            ...
            {.function = HRNLIBSSH2_KNOWNHOST_READFILE, .param = "[\"" KNOWNHOSTS_FILE_CSTR "\",1]",
             .resultInt = LIBSSH2_ERROR_NONE},
            {.function = HRNLIBSSH2_KNOWNHOST_ADDC,
             .param = "[\"localhost\",null,\"12345678901234567890\",20,\"Generated from pgBunker\",23,851969]"},
            {.function = HRNLIBSSH2_KNOWNHOST_WRITEFILE, .param = "[\"" KNOWNHOSTS_FILE_CSTR "\",1]",
             .resultInt = LIBSSH2_ERROR_NONE},
            {.function = HRNLIBSSH2_USERAUTH_PUBLICKEY_FROMFILE_EX,
             .param = "[\"" TEST_USER "\"," TEST_USER_LEN ",\"" KEYPUB_CSTR "\",\"" KEYPRIV_CSTR "\",null]",
        ...
        hrnLibSsh2ScriptSet((HrnLibSsh2 [])
        {
            ...
            {.function = HRNLIBSSH2_KNOWNHOST_READFILE, .param = "[\"" KNOWNHOSTS_FILE_CSTR "\",1]",
             .resultInt = LIBSSH2_ERROR_NONE},
            {.function = HRNLIBSSH2_KNOWNHOST_ADDC,
             .param = "[\"localhost\",null,\"12345678901234567890\",20,\"Generated from pgBunker\",23,1114113]"},
            {.function = HRNLIBSSH2_KNOWNHOST_WRITEFILE, .param = "[\"" KNOWNHOSTS_FILE_CSTR "\",1]",
             .resultInt = LIBSSH2_ERROR_NONE},
            {.function = HRNLIBSSH2_USERAUTH_PUBLICKEY_FROMFILE_EX,
             .param = "[\"" TEST_USER "\"," TEST_USER_LEN ",\"" KEYPUB_CSTR "\",\"" KEYPRIV_CSTR "\",null]",
        ...
        hrnLibSsh2ScriptSet((HrnLibSsh2 [])
        {
            ...
            {.function = HRNLIBSSH2_KNOWNHOST_READFILE, .param = "[\"" KNOWNHOSTS_FILE_CSTR "\",1]",
             .resultInt = LIBSSH2_ERROR_NONE},
            {.function = HRNLIBSSH2_KNOWNHOST_ADDC,
             .param = "[\"localhost\",null,\"12345678901234567890\",20,\"Generated from pgBunker\",23,1376257]"},
            {.function = HRNLIBSSH2_KNOWNHOST_WRITEFILE, .param = "[\"" KNOWNHOSTS_FILE_CSTR "\",1]",
             .resultInt = LIBSSH2_ERROR_NONE},
            {.function = HRNLIBSSH2_USERAUTH_PUBLICKEY_FROMFILE_EX,
             .param = "[\"" TEST_USER "\"," TEST_USER_LEN ",\"" KEYPUB_CSTR "\",\"" KEYPRIV_CSTR "\",null]",
        ...
        hrnLibSsh2ScriptSet((HrnLibSsh2 [])
        {
            ...
            {.function = HRNLIBSSH2_KNOWNHOST_READFILE, .param = "[\"" KNOWNHOSTS_FILE_CSTR "\",1]",
             .resultInt = LIBSSH2_ERROR_NONE},
            {.function = HRNLIBSSH2_KNOWNHOST_ADDC,
             .param = "[\"localhost\",null,\"12345678901234567890\",20,\"Generated from pgBunker\",23,1638401]"},
            {.function = HRNLIBSSH2_KNOWNHOST_WRITEFILE, .param = "[\"" KNOWNHOSTS_FILE_CSTR "\",1]",
             .resultInt = LIBSSH2_ERROR_NONE},
            {.function = HRNLIBSSH2_USERAUTH_PUBLICKEY_FROMFILE_EX,
             .param = "[\"" TEST_USER "\"," TEST_USER_LEN ",\"" KEYPUB_CSTR "\",\"" KEYPRIV_CSTR "\",null]",
        ...
        hrnLibSsh2ScriptSet((HrnLibSsh2 [])
        {
            ...
            {.function = HRNLIBSSH2_KNOWNHOST_READFILE, .param = "[\"" KNOWNHOSTS_FILE_CSTR "\",1]",
             .resultInt = LIBSSH2_ERROR_NONE},
            {.function = HRNLIBSSH2_KNOWNHOST_ADDC,
             .param = "[\"localhost\",null,\"12345678901234567890\",20,\"Generated from pgBunker\",23,1900545]"},
            {.function = HRNLIBSSH2_KNOWNHOST_WRITEFILE, .param = "[\"" KNOWNHOSTS_FILE_CSTR "\",1]",
             .resultInt = LIBSSH2_ERROR_NONE},
            {.function = HRNLIBSSH2_USERAUTH_PUBLICKEY_FROMFILE_EX,
             .param = "[\"" TEST_USER "\"," TEST_USER_LEN ",\"" KEYPUB_CSTR "\",\"" KEYPRIV_CSTR "\",null]",
