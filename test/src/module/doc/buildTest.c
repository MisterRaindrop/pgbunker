...
testRun(void)
{
    ...
    if (testBegin("cmdBuild()"))
    {
                ...
                "<section id=\"command-backup\">"
                    ...
                    "<section id=\"category-command\" toc=\"n\">"
                        ...
                        "<section id=\"option-buffer-size-range\">"
                            ...
                            "<code-block>default: [path of executed pgbunker binary]\n"
                            "example: --cmd=pgbunker</code-block>"
                        "</section>"
        ...
        // -------------------------------------------------------------------------------------------------------------------------
        TEST_TITLE("pgbunker.1.txt");

        TEST_STORAGE_GET(
            storageTest,
            "doc/output/man/pgbunker.1.txt",
            "NAME\n"
            "  pgBunker - Reliable PostgreSQL Backup & Restore\n"
            "\n"
            "SYNOPSIS\n"
            "  pgbunker [options] [command]\n"
            "\n"
            "DESCRIPTION\n"
            "  pgBunker is a reliable backup and restore solution for PostgreSQL...\n"
            "\n"
            "COMMANDS\n"
            ...
            "\n"
            "    $ pgbunker --stanza=main backup\n"
            "\n"
            "    The `main` cluster should be configured in `/etc/pgbunker/pgbunker.conf`\n"
            "\n"
            ...
            "\n"
            "    $ pgbunker --stanza=main info\n"
            "\n"
            "  * Show backup specific options:\n"
            "\n"
            "    $ pgbunker help backup\n"
            "\n"
            "SEE ALSO\n"
            "  /usr/share/doc/pgbunker-doc/html/index.html\n"
